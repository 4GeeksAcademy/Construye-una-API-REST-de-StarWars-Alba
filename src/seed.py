...
with app.app_context():
    ...
    planet2 = Planets(planet_name="Homeneu", population=6876, climate="Humid", diameter=2344, gravity=744, films="A new One")
    ...
    people2 = People(character_name="Lukina Skywalkerina", birth_year="09 BBY", gender="Female", hair_color="Black", height=87, films="A New One", vehicles="Motomami", planet_id=planet2.id)
    people3 = People(character_name="Lukina", birth_year="09 BBY", gender="Female", hair_color="Black", height=87, films="A New One", vehicles="Motomami", planet_id=planet2.id)
    people4 = People(character_name="Luke", birth_year="19 BBY", gender="Male", hair_color="Blond", height=77, films="A New Hope", vehicles="Snowspeeder", planet_id=planet1.id)

    db.session.add_all([people1, people2, people3, people4])
